...
impl Node {
    ...
    pub fn class(&self) -> &str {
        match self {
            Node::Group(ref e) => e.class.as_str(),
            Node::Path(ref e) => e.class.as_str(),
            Node::Image(ref e) => e.class.as_str(),
            Node::Text(ref e) => e.class.as_str(),
        }
    }
...
impl Path {
    ...
    pub(crate) fn new(
        id: String,
        #[cfg(feature = "class")] class: String,
